...
Many, many thanks to the incredible work of all the maintainers of the Jsonata-js reference library.  Jsonata is a very powerful, well-designed, and useful language that has made an impact on many projects.  This work leverages their outstanding work.  The implementation in Rust was strongly influenced by their implementation.  The 1600+ tests they created provided the scaffolding and validation for all of this project.  This project will continue to follow and be a derivative of the reference project.
